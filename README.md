...
- My main tech stack is .NET (C#), Node.js (NestJS), React (Next.js) and Angular.
- I also work with Java (Spring Boot) and Python for specialized backend and data tasks.
...
- Hobbies: Gym, playing football, and F1.
